...
const monodromy_sample_algorithm = EnumerativeAlgorithm(
    ...
    core_function = large_monodromy_sample,
    output_property = monodromy_sample,
    reliability = :numerical_and_random
)

push!(MAIN_ALGORITHMS,monodromy_sample_algorithm)
...
const monodromy_group_via_sample = EnumerativeAlgorithm(
    name = "Group generated by sample",
    input_properties = [monodromy_sample],
    core_function = group_generated_by_monodromy_loops,
    output_property = monodromy_group,
    reliability = :symbolic
)

push!(MAIN_ALGORITHMS,monodromy_group_via_sample)