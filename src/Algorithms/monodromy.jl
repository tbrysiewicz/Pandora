...
const LARGE_MONODROMY_SAMPLE = EnumerativeAlgorithm(
...
push!(MAIN_ALGORITHMS,LARGE_MONODROMY_SAMPLE)
...
const GROUP_GENERATED_BY_MONODROMY_LOOPS = EnumerativeAlgorithm(
